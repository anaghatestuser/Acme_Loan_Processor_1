...
class CreditEvalAgent(PolicyProbeAgentFramework):
    ...
    async def handle(self, context: dict[str, Any]) -> dict[str, Any]:
        ...
        # LINEAJE: enforce() `borrower_record` at agent->agent pre_agent_send — scan flagged AI_DAT_SEC_025 (No file should contain any PII.). Mask/block; do not remove without review. site_id='site:sha256:4728a6fe86fba50c31c38555bb69fa4756f47f1b5a6a69382415de014e12bcc7'
        _gr_client = _lineaje_load_gr_client()
        _gr_site = _gr_client.SiteDescriptor(site_id='site:sha256:4728a6fe86fba50c31c38555bb69fa4756f47f1b5a6a69382415de014e12bcc7', phase='pre_agent_send', boundary={'source': 'agent_message', 'sink': 'agent_message'}, candidate_policies=[], fail_mode='ALLOW_WITH_AUDIT', source_type='agent', destination_type='agent')
        borrower_record = _gr_client.enforce(_gr_site, borrower_record, content_type='application/json', variable_name='borrower_record', source_file=__file__, before_line=81)
