    ...
    async def chat(
        ...
        def _post() -> str:
            try:
                ...
                # LINEAJE: enforce() `response` at api->agent post_tool — scan flagged AI_APP_SEC_059 (Do not allow prompts that can execute malicious commands at runtime.). Mask/block; do not remove without review. site_id='site:sha256:98bf62bcf63737cb4c93e6a9af71c337f7236fbb6fc04a46560d3ecfc4f2128e'
                ...
                if choices:
                    ...
                    # LINEAJE: enforce() `message` at api->agent post_tool — scan flagged AI_IAC_015 (Enforce URL allowlists for agent fetches, tools, and outbound HTTP.); AI_IAC_024 (General purpose AI model integrations must reference a model card or technical documentation). Mask/block; do not remove without review. site_id='site:sha256:73c7ae65179045b5518de53c90348c364df22d56308dc50e84af84ecec964a93'
                    _gr_client = _lineaje_load_gr_client()
